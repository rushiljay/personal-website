...
export function AboutMe() {
  const text =
    "Reesults-driven Computer Science senior at Texas A&M University, passionate about leveraging AI, cloud, and scalable software to solve real-world problems and drive business impact.";
  ...
  return (
      ...
      <div className="bg-[#1e1e1e] dark:bg-[#ffffff] rounded-lg overflow-hidden shadow-xl">
